...
type _ListRepositoriesType = Assert<IsEqual<Awaited<ReturnType<typeof listGitHubRepositories>>, GitHubRepositoriesListResponse["data"]>>;
type _ImportRepositoriesType = Assert<IsEqual<Awaited<ReturnType<typeof importGitHubRepositories>>, ImportGitHubRepositoriesResponse["data"]>>;